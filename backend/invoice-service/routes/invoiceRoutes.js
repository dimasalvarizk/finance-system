...
import { createStandaloneReceipt, getStandaloneReceipts, getStandaloneReceiptById, deleteStandaloneReceipt } from '../controllers/standaloneReceiptController.js';
...
// Standalone / Direct Deposit Receipts (Without requiring invoice / 4-tier approval)
router.get('/standalone-receipts', getStandaloneReceipts);
router.get('/standalone-receipts/:id', getStandaloneReceiptById);
router.post('/standalone-receipts', restrictTo('Super Admin', 'Chief Accountant', 'Division Director', 'Accountant', 'Madinah Branch Accountant'), createStandaloneReceipt);
router.delete('/standalone-receipts/:id', restrictTo('Super Admin', 'Chief Accountant', 'Division Director', 'Madinah Branch Accountant'), deleteStandaloneReceipt);
