 ...
 * Examples:
 *  - 5000 USD -> "Five Thousand United States Dollars Only"
 *  - 18750.50 SAR -> "Eighteen Thousand Seven Hundred Fifty Saudi Riyals and Fifty Halalas Only"
 *  - 75000000 IDR -> "Seventy-Five Million Indonesian Rupiah Only"
 */
...
export function amountToEnglishWords(amount: number, currencyCode: string = 'SAR'): string {
