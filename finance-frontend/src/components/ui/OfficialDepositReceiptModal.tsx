...
const DOC_TEXTS: Record<ReceiptLang, {
  ...
  en: {
    ...
    verifiedSub: 'Generated by ODST Group Finance System',
  ...
  id: {
    ...
    verifiedSub: 'Diterbitkan otomatis oleh Sistem Keuangan ODST Group',
  ...
  ar: {
    ...
    verifiedSub: 'صادرة آلياً عبر النظام المالي لمجموعة أودست (ODST Group)',
                ...
                <div className="space-y-2 max-w-sm">
                  ...
                  <div className="text-[10.5px] text-slate-500 leading-relaxed font-sans">
                    <p className="font-bold text-slate-800 uppercase tracking-wide">
                      ODST GROUP · PT. ODST AIRLINES INDO
                    </p>
          ...
          <div className="pb-2.5 border-b-2 border-slate-800 flex items-start justify-between">
            <div className="space-y-0.5 w-1/2">
              ...
              <div className="text-[8px] text-slate-600 leading-tight font-sans">
                <p className="font-bold text-slate-800">ODST GROUP · PT. ODST AIRLINES INDO</p>
