...
export const ApprovalTable: React.FC<ApprovalTableProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden">
      {/* Table Action Bar */}
      <div className="px-4 sm:px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 border-b border-slate-100 bg-white">
        <div className="flex items-center space-x-3">
          <h2 className="text-[14px] sm:text-[15px] font-bold text-slate-900 tracking-tight flex items-center flex-wrap gap-2">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 w-full sm:w-auto">
          {selectedIds.length > 0 ? (
            <div className="flex flex-wrap items-center gap-2 animate-fade-in">
              <button
                ...
                className="px-3 sm:px-4 py-2 border border-slate-200 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed bg-white text-slate-700 font-semibold text-[12px] sm:text-[12.5px] rounded-xl transition-all cursor-pointer shadow-xs whitespace-nowrap"
              >
              ...
              <button
                ...
                disabled={!isAuthorized}
                className="px-3 sm:px-4 py-2 bg-[#dc2626] hover:bg-[#b91c1c] disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold text-[12px] sm:text-[12.5px] rounded-xl flex items-center space-x-1.5 transition-all cursor-pointer shadow-xs whitespace-nowrap"
              >
              ...
              <button
                ...
                disabled={!isAuthorized}
                className="px-3 sm:px-4 py-2 bg-[#2563eb] hover:bg-[#1d4ed8] disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold text-[12px] sm:text-[12.5px] rounded-xl flex items-center space-x-1.5 transition-all cursor-pointer shadow-xs whitespace-nowrap"
              >
          ...
          <div className="relative flex-1 sm:flex-initial">
            ...
            <input
              ...
              className="w-full sm:w-56 pl-9 pr-4 py-1.5 bg-slate-50 hover:bg-slate-100/80 focus:bg-white border border-slate-200 rounded-xl text-[12.5px] text-slate-800 placeholder-slate-400 focus:outline-none focus:border-blue-500 transition-all font-medium"
            />
            {searchQuery && (
              <button
