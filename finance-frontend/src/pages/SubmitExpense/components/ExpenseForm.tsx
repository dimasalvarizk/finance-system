...
export const ExpenseForm: React.FC<ExpenseFormProps> = ({
  ...
  return (
    <form onSubmit={onSubmit} className="bg-white rounded-2xl border border-slate-200/90 shadow-xs p-4 sm:p-7 space-y-5 sm:space-y-6">
      {errorMessage && (
      ...
      <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2.5 sm:space-x-3 pt-4 border-t border-slate-100">
        <button
          type="button"
          onClick={onCancel}
          className="w-full sm:w-auto px-5 py-2.5 border border-slate-200 text-slate-700 font-semibold rounded-xl text-[13px] hover:bg-slate-50 transition-all cursor-pointer text-center"
        >
        ...
        <button
          ...
          className="w-full sm:w-auto px-6 py-2.5 bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-bold rounded-xl text-[13px] shadow-sm hover:shadow transition-all cursor-pointer disabled:opacity-50 flex items-center justify-center space-x-2 text-center"
        >
